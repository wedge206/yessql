...
namespace YesSql
{
    public class Session : ISession
    {
        ...
        private async Task SaveEntityAsync(object entity)
        {
            ...
            await new CreateDocumentCommand(doc, _tablePrefix).ExecuteAsync(_connection, _transaction, _dialect, Store.Configuration.CommandTimeout, Store.Configuration.Logger);
        ...
        private async Task UpdateEntityAsync(object entity)
        {
            ...
            await new UpdateDocumentCommand(oldDoc, Store.Configuration.TablePrefix).ExecuteAsync(_connection, _transaction, _dialect, Store.Configuration.CommandTimeout, Store.Configuration.Logger);
        }
        ...
        public async Task FlushAsync()
        {
            ...
            try
            {
                ...
                {
                    await command.ExecuteAsync(_connection, _transaction, _dialect, Store.Configuration.CommandTimeout, Store.Configuration.Logger);
                }
            }
            catch
            {
